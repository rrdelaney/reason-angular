...
var App = /** @class */ (function () {
    ...
    App.ngComponentDef = i0.ɵdefineComponent({ type: App, tag: "app", factory: function App_Factory() { return new App(); }, template: function App_Template(ctx, cm) { if (cm) {
            i0.ɵE(0, "h3");
            i0.ɵT(1, "This is my app!");
            i0.ɵe();
            i0.ɵE(2, "p");
            i0.ɵE(3, i1.DisplayName);
            i0.ɵe();
            i0.ɵe();
        } i0.ɵp(3, "name", i0.ɵb(ctx.name)); i1.DisplayName.ngComponentDef.h(4, 3); i0.ɵr(4, 3); } });
    return App;
}());
exports.App = App;
core_1.ɵrenderComponent(App);

},{"./displayName":2,"@angular/core":4}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = require("@angular/core");
var displayNameComponent_1 = require("./displayNameComponent");
var i0 = require("@angular/core");
var DisplayName = /** @class */ (function () {
    function DisplayName(vcr) {
        this.vcr = vcr;
    }
    DisplayName.prototype.ngOnInit = function () {
        // const component = this.cfr.resolveComponentFactory(make)
        console.log(displayNameComponent_1.make);
        this.vcr.createComponent(displayNameComponent_1.make);
    };
    ...
    /** @nocollapse */
    DisplayName.ctorParameters = function () { return [
        { type: core_1.ViewContainerRef, },
    ]; };
    DisplayName.ngComponentDef = i0.ɵdefineComponent({ type: DisplayName, tag: "display-name", factory: function DisplayName_Factory() { return new DisplayName(i0.ɵinjectViewContainerRef()); }, template: function DisplayName_Template(ctx, cm) { if (cm) {
            i0.ɵE(0, "ng-container");
            i0.ɵe();
        } }, inputs: { name: "name" } });
    return DisplayName;
}());
...
},{"./displayNameComponent":3,"@angular/core":4}],3:[function(require,module,exports){
...
displayName.ctorParameters = (function () {
    return /* array */[];
  });

displayName.propDecorators = Js_dict.fromArray(/* array */[/* tuple */[
        "name",
        /* array */[{
            type: Core.Input,
            args: /* array */[]
...
function render(ctx, cm) {
  ...
  Core.ɵt(0, Core.ɵi1("", ctx.name, " Welcome! :D"));
  return /* () */0;
}

displayName.ngComponentDef = Core.ɵdefineComponent({
      type: displayName,
      tag: "display-name",
      factory: (function () {
          return { };
      ...
      template: render,
      inputs: Js_dict.fromArray(/* array */[/* tuple */[
              "name",
              "name"
            ]])
    });

var make = displayName;
...
},{"@angular/core":4,"bs-platform/lib/js/js_dict.js":5}],4:[function(require,module,exports){
(function (global){
/**
 * @license Angular v6.0.0-beta.5
 ...
 * \@stable
 */
var VERSION = new Version('6.0.0-beta.5');
...
function embeddedViewStart(viewBlockId) {
    ...
    if (viewUpdateMode) {
        ...
        var /** @type {?} */ newView = createLView(viewBlockId, renderer, getOrCreateEmbeddedTView(viewBlockId, container), null, null);
...
function renderComponent(componentType, opts) {
    ...
    var /** @type {?} */ oldView = enterView(createLView(-1, rendererFactory.createRenderer(hostNode, componentDef.rendererType), createTView(), null, rootContext), /** @type {?} */ ((null)));
    try {
...
},{"rxjs/Observable":7,"rxjs/Subject":10,"rxjs/Subscription":13,"rxjs/observable/merge":18,"rxjs/operator/share":19}],5:[function(require,module,exports){
'use strict';
...
},{"./Subscriber":12}],7:[function(require,module,exports){
"use strict";
...
},{"./symbol/observable":26,"./util/pipe":39,"./util/root":40,"./util/toSubscriber":42}],8:[function(require,module,exports){
"use strict";
exports.empty = {
    closed: true,
    next: function (value) { },
...
},{"./Observable":7,"./SubjectSubscription":11,"./Subscriber":12,"./Subscription":13,"./symbol/rxSubscriber":27,"./util/ObjectUnsubscribedError":28}],11:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./Observer":8,"./Subscription":13,"./symbol/rxSubscriber":27,"./util/isFunction":34}],13:[function(require,module,exports){
"use strict";
...
},{"./util/UnsubscriptionError":29,"./util/errorObject":30,"./util/isArray":32,"./util/isFunction":34,"./util/isObject":35,"./util/tryCatch":43}],14:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":7,"../util/isScheduler":37,"./EmptyObservable":16,"./ScalarObservable":17}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":7,"../Subject":10,"../Subscriber":12,"../Subscription":13,"../operators/refCount":23}],16:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":7}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":7}],18:[function(require,module,exports){
"use strict";
var Observable_1 = require('../Observable');
...
},{"../Observable":7,"../operators/mergeAll":20,"../util/isScheduler":37,"./ArrayObservable":14}],19:[function(require,module,exports){
"use strict";
...
},{"../operators/share":24}],20:[function(require,module,exports){
"use strict";
...
},{"../util/identity":31,"./mergeMap":21}],21:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../OuterSubscriber":9,"../util/subscribeToResult":41}],22:[function(require,module,exports){
"use strict";
...
},{"../observable/ConnectableObservable":15}],23:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Subscriber":12}],24:[function(require,module,exports){
"use strict";
...
},{"../Subject":10,"./multicast":22,"./refCount":23}],25:[function(require,module,exports){
"use strict";
var root_1 = require('../util/root');
...
},{"../util/root":40}],26:[function(require,module,exports){
"use strict";
var root_1 = require('../util/root');
...
},{"../util/root":40}],27:[function(require,module,exports){
"use strict";
var root_1 = require('../util/root');
...
},{"../util/root":40}],28:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./noop":38}],40:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../InnerSubscriber":6,"../Observable":7,"../symbol/iterator":25,"../symbol/observable":26,"./isArrayLike":33,"./isObject":35,"./isPromise":36,"./root":40}],42:[function(require,module,exports){
"use strict";
var Subscriber_1 = require('../Subscriber');
var rxSubscriber_1 = require('../symbol/rxSubscriber');
var Observer_1 = require('../Observer');
...
},{"../Observer":8,"../Subscriber":12,"../symbol/rxSubscriber":27}],43:[function(require,module,exports){
"use strict";
